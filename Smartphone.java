...
public class Smartphone extends Handphone {
    ...
    public void nyalakan() {
        System.out.println("Smartphone dengan merk " + merk + " dan model " + model + " sedang diproses");
    }

    @Override
    public void matikan() {
        System.out.println("Smartphone dengan merk " + merk + " dan model " + model + " sudah selesai diproses");
    }
